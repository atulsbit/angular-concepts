...
declare namespace uiGrid {
    ...
    export module exporter {
        ...
        export interface IGridExporterApi {
             ...
             */
            csvExport(grid: IGridInstanceOf<any>, rowTypes: string, colTypes: string): void;
            /**
    ...
    export interface IFilterOptions {
         ...
         */
        condition?: number | ((searchTerm: string, cellValue: any, row: IGridRow, column: IGridColumn) => boolean) | RegExp;
        /**
