    ...
    (function (modules) {
        ...
        var IndexController = (function () {
            ...
            IndexController.prototype.getGridSettings = function () {
                ...
                var serviceUrl = self.$window.location.protocol + '//' + self.$window.location.hostname + (self.$window.location.port ? ':' + self.$window.location.port : '') + "/app/modules/home/grid.settings.json";
            ...
            IndexController.prototype.bindData = function () {
                var self = this;
                //forming the data.json url
                var serviceUrl = self.$window.location.protocol + '//' + self.$window.location.hostname + (self.$window.location.port ? ':' + self.$window.location.port : '') + "/app/modules/home/data.json";
